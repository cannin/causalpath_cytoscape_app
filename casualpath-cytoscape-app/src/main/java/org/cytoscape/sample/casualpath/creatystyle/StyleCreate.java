...
public class StyleCreate {
    ...
    public void createStyle(CyNetworkView netView
       ...
       Set<VisualPropertyDependency<?>> visualPropertyDependency = vs.getAllVisualPropertyDependencies();
        ...
        vs.setDefaultValue(BasicVisualLexicon.NODE_BORDER_PAINT,BlackColor);
        ...
        ApplyEnhancedGraphics applyEnhancedGraphics = new ApplyEnhancedGraphics(cyServiceRegistrar,cyNetwork,vs);
        ...
        vs = applyEnhancedGraphics.perform("NODE_CUSTOMGRAPHICS_2",labeltextSettings2,1,vizCol+1);
