...
public class LabeltextSettings implements Serializable {
    ...
    public static final String LABEL_COLOR_PROPERTY = "color";
    ...
    public static final String LABEL_SIZE_DEFAULT = "12";
    ...
    public static final String OUTLINE_PROPERTY_DEFAULT = "false";
